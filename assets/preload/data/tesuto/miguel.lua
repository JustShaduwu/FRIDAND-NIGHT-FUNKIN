...
name_of_character_xml = 'miguel-og' -- Nombre del Xml y sprite
name_of_character = 'miguel-og' -- Nombre que le pondras al personaje
name_of_notetype = 'Miguel Note' -- Nombre de su flecha individual
...
idle_xml_name = 'idle_miguel'
left_xml_name = 'left_miguel'
down_xml_name = 'down_miguel'
up_xml_name = 'up_miguel'
right_xml_name = 'right_miguel'
