...
name_of_character_xml = 'sofia-og' -- Nombre del Xml y sprite
name_of_character = 'sofia-og' -- Nombre que le pondras al personaje
name_of_notetype = 'Sofia Note' -- Nombre de su flecha individual
...
idle_xml_name = 'idle_sofia'
left_xml_name = 'left_sofia'
down_xml_name = 'down_sofia'
up_xml_name = 'up_sofia'
right_xml_name = 'right_sofia'
...
function onBeatHit()
	...
	if curBeat % 84 == 0  and doIdle then
		objectPlayAnimation(name_of_character, 'idle');
		setProperty(name_of_character .. '.offset.x', idleoffsets[1]);
		setProperty(name_of_character .. '.offset.y', idleoffsets[2]);
