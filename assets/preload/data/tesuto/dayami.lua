...
name_of_character_xml = 'dayami-og' -- Nombre del Xml y sprite
name_of_character = 'dayami-og' -- Nombre que le pondras al personaje
name_of_notetype = 'Dayami Note' -- Nombre de su flecha individual
...
idle_xml_name = 'dayami_idle'
left_xml_name = 'dayami_left'
down_xml_name = 'dayami_down'
up_xml_name = 'dayami_up'
right_xml_name = 'dayami_right'
