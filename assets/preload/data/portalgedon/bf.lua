...
name_of_character_xml = 'BOYFRIEND' -- Nombre del Xml y sprite
name_of_character = 'bf' -- Nombre que le pondras al personaje
name_of_notetype = 'GF Sing' -- Nombre de su flecha individual
...
function onBeatHit()
	...
	if curBeat % 643 == 0  and doIdle then
		objectPlayAnimation(name_of_character, 'idle');
		setProperty(name_of_character .. '.offset.x', idleoffsets[1]);
		setProperty(name_of_character .. '.offset.y', idleoffsets[2]);
