...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * 0.07, bgSprite.y + 425).loadGraphic(Paths.themeImage('Menu_Tracks'));
	...
	function changeDifficulty(change:Int = 0):Void
	{
		...
		var newImage:FlxGraphic = Paths.themeImage('menudifficulties/' + Paths.formatToSongPath(diff));
