...
class ReplayState extends PlayState
{
    ...
    public static var replayHits:Array<Null<Float>> = [];
    ...
    public function new(_song:String, curDiff:Int)
    {
        super();
    ...
    override function create():Void
    {
        ...
        #else
        var file:ReplayFile = Json.parse(OpenFlAssets.getText(Paths.getPreloadPath('replays/$_song $curDiff.json')));
        #end
    ...
    function StrumPress(id:Int, ?time:Float):Void
    {
