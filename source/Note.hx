...
class Note extends FlxSprite
{
	...
	var hasNormalNotes:Bool = false;
	var gfxLetter:Array<String> = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 
	'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q', 'R'];
	public static var usablesLetters:Array<String> = ['A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'M'];
	...
	public static var keysShit:Map<Int, Map<String, Dynamic>> = [
		...
		9 => ["letters" => ["A", "B", "C", "D", "E", "J", "F", "G", "H", "I"], "anims" => ["LEFT", "DOWN", "UP", "RIGHT", "LEFT", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT"],
			 "strumAnims" => ["LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT"], "pixelAnimIndex" => [0, 1, 2, 3, 9, 10, 5, 6, 7, 8]],

		10=> ["letters" => ["A", "B", "C", "D", "J", "E", "M", "F", "G", "H", "I"], "anims" => ["LEFT", "DOWN", "UP", "RIGHT", "LEFT", "UP", "RIGHT", "LEFT", "DOWN", "UP", "RIGHT"],
			 "strumAnims" => ["LEFT", "DOWN", "UP", "RIGHT", "CIRCLE", "SPACE", "CIRCLE", "LEFT", "DOWN", "UP", "RIGHT"], "pixelAnimIndex" => [0, 1, 2, 3, 9, 4, 10, 5, 6, 7, 8]],
			
		
		11 => ["letters" => ["left", "down", "up", "right"], "anims" => ["LEFT", "DOWN", "UP", "RIGHT"], "strumAnims" => ["LEFT", "DOWN", "UP", "RIGHT"], "pixelAnimIndex" => [0, 1, 2, 3]],
	];
	...
	public var forceBotplay:Bool = false;
	public var countInCombo:Bool = true;
	...
	private function set_downScroll(value:Bool):Bool {
		if(downScroll != value) {
			downScroll = value;
			if (isSustainNote)
				flipY = value;
	...
	private function set_noteType(value:String):String {
		...
		colorSwap.hue = ClientPrefs.arrowHSV.get(Note.keysShit.get(mania).get('letters')[noteData])[0] / 360;
	...
	function loadNoteAnims() {
		for (i in 0...gfxLetter.length)
			{
				if (i == 0) {
					animation.addByPrefix(gfxLetter[i], 'purple0');
					if (animation.getByName(gfxLetter[i]) == null)
						animation.addByPrefix(gfxLetter[i], gfxLetter[i] + '0');
				}
				else if (i == 1) {
					animation.addByPrefix(gfxLetter[i], 'blue0');
					if (animation.getByName(gfxLetter[i]) == null)
						animation.addByPrefix(gfxLetter[i], gfxLetter[i] + '0');
				}
				else if (i == 2) {
					animation.addByPrefix(gfxLetter[i], 'green0');
					if (animation.getByName(gfxLetter[i]) == null)
						animation.addByPrefix(gfxLetter[i], gfxLetter[i] + '0');
				}
				else if (i == 3) {
					animation.addByPrefix(gfxLetter[i], 'red0');
					if (animation.getByName(gfxLetter[i]) == null)
						animation.addByPrefix(gfxLetter[i], gfxLetter[i] + '0');
				}
				else {
				...
				{
					if (i == 0) {
						animation.addByPrefix(gfxLetter[i] + ' hold', 'purple hold piece');
						if (animation.getByName(gfxLetter[i] + ' hold') == null)
							animation.addByPrefix(gfxLetter[i] + ' hold', gfxLetter[i] + ' hold');
					}
					else if (i == 1) {
						animation.addByPrefix(gfxLetter[i] + ' hold', 'blue hold piece');
						if (animation.getByName(gfxLetter[i] + ' hold') == null)
							animation.addByPrefix(gfxLetter[i] + ' hold', gfxLetter[i] + ' hold');
					}
					else if (i == 2) {
						animation.addByPrefix(gfxLetter[i] + ' hold', 'green hold piece');
						if (animation.getByName(gfxLetter[i] + ' hold') == null)
							animation.addByPrefix(gfxLetter[i] + ' hold', gfxLetter[i] + ' hold');
					}
					else if (i == 3) {
						animation.addByPrefix(gfxLetter[i] + ' hold', 'red hold piece');
						if (animation.getByName(gfxLetter[i] + ' hold') == null)
							animation.addByPrefix(gfxLetter[i] + ' hold', gfxLetter[i] + ' hold');
					}
					else {
					...
					if (i == 0) {
						...
						if (animation.getByName(gfxLetter[i] + ' tail') == null)
							animation.addByPrefix(gfxLetter[i] + ' tail', gfxLetter[i] + ' tail');
					}
					else if (i == 1) {
						animation.addByPrefix(gfxLetter[i] + ' tail', 'blue hold end');
						if (animation.getByName(gfxLetter[i] + ' tail') == null)
							animation.addByPrefix(gfxLetter[i] + ' tail', gfxLetter[i] + ' tail');
					}
					else if (i == 2) {
						animation.addByPrefix(gfxLetter[i] + ' tail', 'green hold end');
						if (animation.getByName(gfxLetter[i] + ' tail') == null)
							animation.addByPrefix(gfxLetter[i] + ' tail', gfxLetter[i] + ' tail');
					}
					else if (i == 3) {
						animation.addByPrefix(gfxLetter[i] + ' tail', 'red hold end');
						if (animation.getByName(gfxLetter[i] + ' tail') == null)
							animation.addByPrefix(gfxLetter[i] + ' tail', gfxLetter[i] + ' tail');
					}
					else {
			...
			if (!isSustainNote)
				...
				setGraphicSize(Std.int(width * scales[mania]), Std.int(width * scales[0]));

			//I desactivated this beacause of a bug with custom notes
			/*
			if (!isSustainNote)
	...
	function loadPixelNoteAnims() {
		if(isSustainNote) {
			if (PlayState.mania == 3 && hasNormalNotes) {
				for (i in 0...gfxLetter.length) {
					animation.add(gfxLetter[i] + ' hold', [i]);
					animation.add(gfxLetter[i] + ' tail', [i + 4]);
				}
			}
			else {
				for (i in 0...gfxLetter.length) {
