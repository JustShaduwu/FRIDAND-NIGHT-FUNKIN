...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Shaduwu', 			'shaduwu',			'All of the Mod Shit jeje..',                               	'https://twitter.com/AndShadow13', 	                        	'187104'],
			...
			['Voyager of The Portal (Cinematic Music)', 'and-og',	    'Composed by Shaduwu',                             'nolink',			      		                             	'00FF00'],
	        ['Foreshadow Curse (Cinematic Music)',      'shadow-and-body-og',	'Composed by Shaduwu',                     'nolink',			      		                                'FF000D'],
			[''],
			['Weird Engine'],
