...
{
	public static var shadowEngineVersion:String = '0.0.1'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Shadow Engine v" + shadowEngineVersion + weirdEngineBetaVersion + ' (PE ${psychEngineVersion})', 12);
